  ...
  return function () {
    ...
    var Styled = withEmotionCache(function (props, context, ref) {
      return React.createElement(ThemeContext.Consumer, null, function (theme) {
        ...
        if (typeof props.className === 'string') {
          className = getRegisteredStyles$1(context.registered, classInterpolations, props.className);
        } else if (props.className != null) {
          className = props.className + " ";
        }

        var serialized = serializeStyles(styles.concat(classInterpolations), context.registered, mergedProps);
        var rules = insertStyles$1(context, serialized, typeof finalTag === 'string');
...
var getTheme = function getTheme(outerTheme, theme) {
  ...
  return _objectSpread$1({}, outerTheme, {}, theme);
};

var createCacheWithTheme = weakMemoize$1(function (outerTheme) {
...
function useMedia(queries, values, defaultValue) {
    ...
    var _a = React.useState(getValue), value = _a[0], setValue = _a[1];
...
function useDarkMode() {
    ...
    var _a = useLocalStorage("dark-mode-enabled"), enabledState = _a[0], setEnabledState = _a[1];
...
var ThemeProvider$1 = function (_a) {
    ...
    var _b = useDarkMode(), darkMode = _b[0], setDarkMode = _b[1];
    // Merge the color mode with the base theme to create a new theme object
    var getTheme = function (mode) {
        return merge_1({}, theme, {
            colors: get_1(theme.colors.modes, mode, theme.colors),
            isDark: true,
        });
    };
...
var useTheme = function () {
    var context = React__default.useContext(ThemeContext$1);
