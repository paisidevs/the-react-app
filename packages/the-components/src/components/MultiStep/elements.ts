...
export const Tracks = styled.ol<{ verticalTrack: boolean }>`
  display: flex;
  justify-content: center;
  margin: 0;
  padding: 40px 0;
...
export const Track = styled.li<{ verticalTrack: boolean }>`
  align-items: ${({ verticalTrack }) =>
    verticalTrack ? 'flex-start' : 'center'};
  display: flex;
  flex-direction: column;
  justify-content: center;
